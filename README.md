...
|--------|----------|-----------|
| GET | `/biblioteca/livros` | Lista todos os livros ordenados por título |
| GET | `/biblioteca/livros/{id}` | Busca um livro pelo ID |
| GET | `/biblioteca/livros/categoria/{categoria}` | Filtra livros por categoria |
| POST | `/biblioteca/livros` | Cadastra um novo livro |
